...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="saveClueForm" role="form">
                        ...
                        <div style="height: 1px; width: 103%; background-color: #2639d5; left: -13px; position: relative; top : 10px;"></div>
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<%--分页插件--%>
			<div style="height: 40px; position: relative;top: 15px;">
				<div id="CluePage"  >
				</div>
			</div>
...
<script>
	...
	function pageList(page,pageSize) {
		...
		$.ajax({
			url: '/crm/workbench/clue/listClue',
			data:{'page':page,
				'pageSize':pageSize},
			type:'get',
			dataType:'json',
			success:function(data){
				...
				for (var i=0;i<dataList.length;i++){
					$('#clueBody').append("<tr>\n" +
							"<td><input type=\"checkbox\" /></td>\n" +
							"<td><a style=\"text-decoration: none; cursor: pointer;\" href=/crm/workbench/clue/queryClueDetailById?id="+dataList[i].id+">"+dataList[i].fullname+"</a></td>\n" +
							"<td>"+dataList[i].company+"</td>\n" +
